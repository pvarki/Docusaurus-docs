...
Situational Awareness platform by US DoD. You can do about anything a soldier needs with TAK, given that you know how to do it AND you have a server. We aim to do both as easy to you as possible.

### Battlelog (MVP done at 1.7.0)

Log & know what happens in your Battlespace. Visualize things in a Timeline, search things by their themes & labels and add in your analysis, thing by thing. Killer of all those recon Excels.

### MediaMTX (MVP as a release candidate)

Stream & watch streams like a breeze, with any device. Never been so easy to setup video monitoring.
