---
title: "pvarki/python-mediamtx-rmmtxauthz – README"
---

> **Integration tag:** `1.15.2` · **Submodule commit:** `55921125444547f67089706f64432e5e3aef7763`  
> **Repo:** git@github.com:pvarki/python-mediamtx-rmmtxauthz.git  
> **Browse at this commit:** https://github.com/pvarki/python-mediamtx-rmmtxauthz/tree/55921125444547f67089706f64432e5e3aef7763
...
If you get weird errors about missing packages from pre-commit try
running it with "poetry run pre-commit".
...
Running "pre-commit run --all-files" and "py.test -v" regularly during
development and especially before committing will save you some
headache.
