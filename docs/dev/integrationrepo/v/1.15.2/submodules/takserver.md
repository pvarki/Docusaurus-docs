...
> **Integration tag:** `1.15.2` · **Submodule commit:** `7a73302fef52d0e4b76b11bbda92afefaab43732`  
> **Repo:** git@github.com:pvarki/docker-atak-server.git  
> **Browse at this commit:** https://github.com/pvarki/docker-atak-server/tree/7a73302fef52d0e4b76b11bbda92afefaab43732
...
or use docker compose.local.yml without gomplate for local dev
...
Note, for things that live in the volumes (like TAK certs) you must nuke
the volumes to see changes:
...
Then get /opt/tak/certs/files/clientpkgs/replaceme.zip out of the
container:
...
This approach also works for recovering the admin cert
(/opt/tak/certs/files/admin.p12 unless you changed the ADMIN_CERT_NAME
ENV)
...
See above about the hard way of getting the cert file, or use the REST
API.
