...
Create `.env` file that defines environmental variables for Rasenmaeher
...
Keycloack Admin UI. (Later group management will be withing
Rasenmaeher):
...
3.  Approve users in Rasenmaeher. Open approvement link or scan qr code
...
1.  Login to Rasenmaeher. Go to [https://mtls.domain](https://mtls.domain) and select TAK.
...
> - Swagger definition for RASENMAEHER API:
