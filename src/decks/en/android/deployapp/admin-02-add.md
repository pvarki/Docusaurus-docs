...
### 1. Admin Tools
@[phoneFrame](
  screenshot="/img/deployapp/crossplatform/manageusers-en.png",
  alt="Initial Screen",
  top="8%", left="7.5%", width="85%", height="84%",
...
### 2. Add Users
@[phoneFrame](
  screenshot="/img/deployapp/crossplatform/manageusers-highlightadd-en.png",
  alt="Initial Screen",
  top="8%", left="7.5%", width="85%", height="84%",
...
@[phoneFrame](
  screenshot="/img/deployapp/crossplatform/addusers-en.png",
  alt="Initial Screen",
  top="8%", left="7.5%", width="85%", height="84%",
...
@[phoneFrame](
  screenshot="/img/deployapp/crossplatform/addusers-createcode-en.png",
  alt="Initial Screen",
  top="8%", left="7.5%", width="85%", height="84%",
...
@[phoneFrame](
  screenshot="/img/deployapp/crossplatform/addusers-qrcode-en.png",
  alt="Initial Screen",
  top="8%", left="7.5%", width="85%", height="84%",
...
@[phoneFrame](
  screenshot="/img/deployapp/crossplatform/addusers-qrcode-highlightlink-en.png",
  alt="Initial Screen",
  top="8%", left="7.5%", width="85%", height="84%",
...
@[phoneFrame](
  screenshot="/img/deployapp/crossplatform/enroll-acceptlink-processing.png",
  alt="",
  top="8%", left="7.5%", width="85%", height="84%",
...
### 4. Approving Users
@[phoneFrame](
  screenshot="/img/deployapp/crossplatform/manageusers-highlightapprove-en.png",
  alt="",
  top="8%", left="7.5%", width="85%", height="84%",
...
@[phoneFrame](
  screenshot="/img/deployapp/crossplatform/enroll-acceptlink-2.png",
  alt="",
  top="8%", left="7.5%", width="85%", height="84%",
...
### 4.4. Tap Accept
@[phoneFrame](
  screenshot="/img/deployapp/crossplatform/enroll-acceptlink-accept-en.png",
  alt="",
  top="8%", left="7.5%", width="85%", height="84%",
...
### 4.6. That's It
@[phoneFrame](
  screenshot="/img/deployapp/crossplatform/enroll-acceptlink-accepted-en.png",
  alt="",
  top="8%", left="7.5%", width="85%", height="84%",
...
@[phoneFrame](
  screenshot="/img/deployapp/crossplatform/addusers-approveusers-en.png",
  alt="",
  top="8%", left="7.5%", width="85%", height="84%",
...
@[phoneFrame](
  screenshot="/img/deployapp/crossplatform/addusers-removecode-en.png",
  alt="",
  top="8%", left="7.5%", width="85%", height="84%",
