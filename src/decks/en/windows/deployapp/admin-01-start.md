Note we got phone-frames on images here temporarily, but they content is from Windows anyway. 
...
@[screenshotBox](
  screenshot="/img/deployapp/win/enroll-installcert-win-dl-en.png",
  alt="Initial Screen",
  top="8%", left="7.5%", width="85%", height="84%",
...
@[screenshotBox](
  screenshot="/img/deployapp/win/enroll-installcert-win-dl2-en.png",
  alt="Initial Screen",
  top="8%", left="7.5%", width="85%", height="84%",
...
@[screenshotBox](
  screenshot="/img/deployapp/win/enroll-installcert-win-1-en.png",
  alt="Initial Screen",
  top="8%", left="7.5%", width="85%", height="84%",
...
@[screenshotBox](
  screenshot="/img/deployapp/win/enroll-installcert-win-2-en.png",
  alt="Initial Screen",
  top="8%", left="7.5%", width="85%", height="84%",
...
@[screenshotBox](
  screenshot="/img/deployapp/win/enroll-installcert-win-3-en.png",
  alt="Initial Screen",
  top="8%", left="7.5%", width="85%", height="84%",
  caption="Click Next.")
...
@[screenshotBox](
  screenshot="/img/deployapp/win/enroll-installcert-win-4-en.png",
  alt="Initial Screen",
  top="8%", left="7.5%", width="85%", height="84%",
...
@[screenshotBox](
  screenshot="/img/deployapp/win/enroll-installcert-win-5-en.png",
  alt="Initial Screen",
  top="8%", left="7.5%", width="85%", height="84%",
...
@[screenshotBox](
  screenshot="/img/deployapp/win/enroll-installcert-win-6-en.png",
  alt="Initial Screen",
  top="8%", left="7.5%", width="85%", height="84%",
